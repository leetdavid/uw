...
Current work: establish the [Chromium source-build pipeline](../building.md). Full compilation and a browser smoke test are pending a suitable build host.
...
| --- | --- | --- |
| [Chromium build foundation](../building.md) | 7/10 | Established upstream tools; a full Xcode installation and a large build volume are required. |
